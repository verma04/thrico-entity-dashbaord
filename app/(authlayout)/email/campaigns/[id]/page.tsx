    ...
    return (
      <EcosystemWrapper className="gap-4">
        <EcosystemHeader
          ...
          description="Loading campaign performance metrics…"
          icon={Megaphone}
          badgeText="Analytics"
          breadcrumbs={[
        ...
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-3">
          {Array.from({ length: 4 }).map((_, i) => (
            <Card key={i} className="border-border/60 bg-card p-4 space-y-3">
  ...
  return (
    <EcosystemWrapper className="gap-4 animate-in fade-in duration-500">
      ...
      <EcosystemContainer className="p-0 m-0 border-none bg-transparent shadow-none ring-0 space-y-6">
        ...
        {chartData.length > 0 && (
          <div className="p-5 rounded-xl border border-border/60 bg-card shadow-2xs space-y-4">
