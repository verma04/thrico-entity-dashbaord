...
export default function ForumAuditLog() {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">
            Track all activity and administrative changes made to this forum.
          </p>
        </div>
      ...
      <div className="bg-card rounded-2xl border-none shadow-lg shadow-black/[0.03] ring-1 ring-border/40 overflow-hidden">
        <div className="p-1">
          <AdminTable
            ...
            emptyDescription="No activity has been recorded for this forum yet."
            pagination={{
              pageIndex: page - 1,
              pageSize: 12,
