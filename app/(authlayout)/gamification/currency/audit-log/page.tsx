...
export default function CurrencyAuditLogPage() {
  ...
  if (error) {
    return (
      <EcosystemWrapper>
        <EcosystemHeader title="Audit Log" badgeText={currencyModuleName} description={`Full ${currencyModuleName.toLowerCase()} transaction history.`} icon={History} breadcrumbs={[{ label: "Gamification", href: "/gamification" }, { label: "Currency", href: "/gamification/currency" }, { label: "Audit Log" }]} />
  ...
  return (
    <EcosystemWrapper>
      <EcosystemHeader
        ...
        icon={History}
        breadcrumbs={[{ label: "Gamification", href: "/gamification" }, { label: "Currency", href: "/gamification/currency" }, { label: "Audit Log" }]}
      />
