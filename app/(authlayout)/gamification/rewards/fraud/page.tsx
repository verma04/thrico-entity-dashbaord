            ...
            sidebar={
              <>
                ...
                <PolarisSidebarCard
                  ...
                  icon={Sparkles}
                >
                  <div className="rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-white dark:bg-zinc-900 p-3 space-y-2.5 shadow-2xs">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <h4 className="font-semibold text-[12.5px] text-[#303030] dark:text-zinc-100">
              ...
              >
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                  <PolarisInput
                    ...
                    type="number"
                    min={0}
                    label="Daily Platform Redemption Cap"
                    prefix={<Zap className="h-3.5 w-3.5" />}
                    suffix="CLAIMS"
                    helperText="Max total rewards redeemable across 24h · 0 for unlimited"
                  ...
                  <PolarisInput
                    ...
                    type="number"
                    min={0}
                    label="Max IP Velocity (Per Hour)"
                    prefix={<Globe className="h-3.5 w-3.5" />}
                    suffix="PER IP"
                    helperText="Max redemptions allowed from a single IP address per hour"
              ...
              >
                <div className="space-y-2.5">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-[#f6f6f7]/50 dark:bg-zinc-800/40">
                    <div className="flex items-center gap-2.5">
                      <div className="h-7 w-7 rounded-[4px] bg-white dark:bg-zinc-800 flex items-center justify-center shrink-0 border border-[#d2d5d9] dark:border-zinc-700">
                        <UserCheck className="h-3.5 w-3.5 text-[#303030] dark:text-zinc-100" />
                      </div>
                  ...
                  <div className="flex items-center justify-between p-3 rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-[#f6f6f7]/50 dark:bg-zinc-800/40">
                    <div className="flex items-center gap-2.5">
                      <div className="h-7 w-7 rounded-[4px] bg-white dark:bg-zinc-800 flex items-center justify-center shrink-0 border border-[#d2d5d9] dark:border-zinc-700">
                        <Smartphone className="h-3.5 w-3.5 text-[#303030] dark:text-zinc-100" />
                      </div>
                      <div className="space-y-0.5">
                        <span className="text-[12.5px] font-semibold text-[#303030] dark:text-zinc-100 block">
