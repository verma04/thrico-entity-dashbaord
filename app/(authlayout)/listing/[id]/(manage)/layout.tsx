            ...
            <div className="flex items-center justify-between py-4">
              <div className="flex items-center gap-4">
                {listing?.media && listing.media.length > 0 ? (
                  ...
                  <div className="w-11 h-11 rounded-xl bg-muted/60 border border-border/60 flex items-center justify-center relative">
              ...
              <Button
                ...
                onClick={() => router.push("/listing/all")}
              >
                <X className="h-4 w-4" />
              </Button>
            </div>
              ...
              {tabItems.map((tab) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      if (tab.key === "manage") {
                        router.push(`/listing/${id}/manage`);
                      } else {
                        router.push(`/listing/${id}/${tab.key}`);
                      }
                    }}
                    className={cn(
