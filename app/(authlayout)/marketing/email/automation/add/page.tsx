...
function NewCampaignPage() {
  ...
  const handleBack = () => {
    ...
    else router.push("/marketing/email/automation");
  };
  ...
  const handleLaunch = async () => {
    ...
    try {
      ...
      router.push("/marketing/email/automation/add/canvas");
    } finally {
    ...
    <EcosystemWrapper className="animate-in fade-in duration-500 gap-4">
      <EcosystemHeader
        ...
        breadcrumbs={[
          ...
          { label: "Automations", href: "/marketing/email/automation" },
          { label: "New Campaign" },
        ]}
        actions={
              ...
              <div className="w-full max-w-2xl space-y-6">
                ...
                {selectedTemplate && selectedTemplate.id !== "blank" && (
                  <div className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-indigo-100 bg-indigo-50">
                    ...
                    {selectedTemplate.emailTemplateName && (
                      <a href="/marketing/email/templates" target="_blank"
