...
function OpportunitiesSettingsPage() {
  ...
  const initialSettings: OpportunitiesSettingsState = {
    ...
    aiModerationOpportunities:
      data?.getEntitySettings?.aiModerationOpportunities ?? false,
  };
      ...
      await update({
        variables: {
          input: {
            ...
            aiModerationOpportunities: formData.aiModerationOpportunities,
          },
        },
      });
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <div className="space-y-1 pt-2 border-t border-[#e1e3e5] dark:border-zinc-800">
                  ...
                  <PolarisSummaryRow
                    label="AI Moderation"
                    value={formData.aiModerationOpportunities ? "Active" : "Disabled"}
                    highlight={formData.aiModerationOpportunities}
                    isLast
                  />
                </div>
              </PolarisSidebarCard>
        ...
        >
          <div className="space-y-3.5">
            ...
            <PolarisFormCard
              ...
              description={`Automate opportunity inspection and spam filtering with autonomous AI moderation.`}
              badge="AI Safety"
            >
              <div className="flex items-start justify-between p-3 rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-[#f6f6f7]/50 dark:bg-zinc-900/40 hover:bg-[#f6f6f7] dark:hover:bg-zinc-800/40 transition-colors">
                <div className="flex items-start gap-2.5">
                  <div
                    className={cn(
                      "h-7 w-7 rounded-[4px] flex items-center justify-center shrink-0 border transition-colors mt-0.5",
                      formData.aiModerationOpportunities
                  ...
                  <div className="space-y-0.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      >
                        {formData.aiModerationOpportunities ? "Protected" : "Disabled"}
                      </Badge>
                    </div>
                    <p className="text-[11px] text-[#616161] dark:text-zinc-400 leading-[15px]">
                      Leverage AI models to scan newly posted opportunities for fraudulent listings, scams, policy violations, and spam.
                    </p>
                  </div>
                </div>
                <Switch
                  checked={formData.aiModerationOpportunities}
                  onCheckedChange={() => handleToggle("aiModerationOpportunities")}
                />
              </div>
            </PolarisFormCard>
          </div>
