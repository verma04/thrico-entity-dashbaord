...
export default function PollAuditLogPage() {
  const singularName =
  ...
  const handleExportLogs = () => {
    ...
    const csv = buildCsv(logs, [
      ...
      { header: "Module", getValue: (l: any) => l.module || "POLLS" },
      {
      ...
      {
        header: "Notes",
        getValue: (l: any) => l.reason || "",
      },
    ]);

    downloadCsv(csv, `poll-audit-${moment().format("YYYY-MM-DD")}`);
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-card border border-border/60 rounded-xl p-4 shadow-2xs">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">
            Cryptographically recorded mutations, vote tallies, status adjustments, and configuration changes for this {singularName.toLowerCase()}.
          </p>
        </div>
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    {
                      label: "Module",
                      val: logDetailsData.auditLogById.module || "POLLS",
                      icon: Globe,
                    },
                    {
                      label: "Time",
                    ...
                    },
                    {
                      ...
                      val: logDetailsData.auditLogById.admin?.firstName
                        ...
                        : logDetailsData.auditLogById.adminId ||
                          "System Automation",
                      icon: User,
                    },
                    {
