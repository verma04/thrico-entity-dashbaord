...
export default function CouponsPage() {
  ...
  return (
    <EcosystemWrapper>
                ...
                return (
                  ...
                  >
                    ...
                    {tab.count !== undefined && (
                      <span
                        className={cn(
                          "relative z-10 inline-flex h-4 min-w-[16px] px-1 items-center justify-center rounded-md text-[9px] font-black tabular-nums transition-colors",
                          isActive
                            ? "bg-indigo-600 text-white"
                            : "bg-zinc-200 text-zinc-600 group-hover/tab:bg-zinc-300",
                        )}
                      >
                        {tab.count}
                      </span>
          ...
          {activeTab === "rewards" ? (
            <EcosystemActionBar.Item>
              <Link href="/rewards/coupons/create">
                <Button
                  size="sm"
                  className="h-9 px-4 rounded-xl gap-2 font-black uppercase tracking-tighter shadow-md ring-1 ring-black/5"
                >
          ...
          <EcosystemActionBar.Item>
            ...
            >
              <RotateCw
                size={14}
                className={cn(
                  rewardsLoading || vouchersLoading ? "animate-spin" : "",
                )}
              />
            </Button>
          </EcosystemActionBar.Item>
      ...
      <EcosystemActionBar
        shadow="none"
        className="bg-transparent border-none py-0 -mt-2"
      >
        {activeTab === "rewards" && (
        ...
        {activeTab === "inventory" && (
          <div className="flex items-center gap-4 px-1 py-1 bg-indigo-50/50 border border-indigo-100/50 rounded-xl w-full">
            ...
            <div className="flex items-center gap-4">
              <span className="text-[11px] font-bold text-indigo-700 tracking-tighter uppercase whitespace-nowrap">
                Inventory Status Nexus:
              </span>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <DialogDescription className="text-xs font-medium text-muted-foreground mt-1">
                    Feed unique voucher credentials into your economic engine
                    via CSV protocol.
                  </DialogDescription>
                </div>
              </div>
            ...
            <div className="space-y-5">
              <div className="space-y-2">
                <Label className="text-[11px] font-black text-muted-foreground uppercase tracking-widest px-1">
                  Source Destination Reward
                </Label>
                <Select
                  value={uploadRewardId}
                  onValueChange={setUploadRewardId}
                >
              ...
              {uploadStep === "idle" && (
                <div className="space-y-4 animate-in fade-in slide-in-from-bottom-2 duration-500">
                  ...
                  <div
                    className={cn(
                      "border-2 border-dashed rounded-3xl p-10 flex flex-col items-center gap-4 cursor-pointer transition-all duration-500 group",
                      isDragging
                        ? "border-indigo-400 bg-indigo-50/50 scale-[1.02]"
                        : "border-border hover:border-indigo-300 hover:bg-zinc-50",
                    )}
                  ...
                  >
                    ...
                    <div className="text-center">
                      <p className="text-[13px] font-black text-foreground uppercase tracking-tight">
                        {isDragging
                          ? "Protocol Accepted: Drop Now"
                          : "Establish Link: Click or Drop CSV"}
                      </p>
                      <p className="text-[10px] font-bold text-muted-foreground/60 mt-1 uppercase tracking-widest">
                        Supports up to 50,000 Unique Entries
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 p-4 rounded-2xl bg-indigo-50/30 border border-indigo-100/50">
                    ...
                    <p className="text-[11px] text-indigo-700 font-medium leading-relaxed">
                      ...
                      >
                        Voucher Schema Template
                      </span>{" "}
                      to ensure seamless ingestion and prevent allocation errors
                      during the upload cycle.
                    </p>
                  </div>
                </div>
              )}
              ...
              {uploadStep === "summary" && (
                <div className="space-y-4 animate-in zoom-in-95 duration-500">
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-zinc-50 border border-zinc-200 shadow-inner">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[13px] font-black text-foreground truncate uppercase tracking-tight">
                        {uploadedFile?.name}
                      </p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-emerald-50 border border-emerald-100 p-5 rounded-2xl shadow-sm">
                      ...
                      <p className="text-[9px] font-black text-emerald-700/70 uppercase tracking-widest mt-1 leading-none">
                        Accepted Records
                      </p>
                    </div>
                    {invalidCount > 0 && (
                      <div className="bg-rose-50 border border-rose-100 p-5 rounded-2xl shadow-sm">
                        ...
                        <p className="text-[9px] font-black text-rose-700/70 uppercase tracking-widest mt-1 leading-none">
                          Invalid Signals
                        </p>
                      </div>
                    )}
          ...
          <div className="bg-zinc-50 p-6 flex items-center justify-end gap-3 border-t border-border/50">
            ...
            {uploadStep === "summary" && validCount > 0 && (
              <Button
                ...
                disabled={uploading}
                className="h-11 px-8 rounded-xl gap-3 font-black uppercase tracking-widest shadow-xl"
              >
                {uploading ? (
