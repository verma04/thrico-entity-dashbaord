      ...
      <div className="rounded-xl border border-slate-200/80 bg-white shadow-sm overflow-hidden flex flex-col">
        ...
        <div className="divide-y divide-slate-100 p-0">
          {filteredIntegrations.map((integration) => (
            <div key={integration.id} className="p-5 hover:bg-slate-50/30 transition-colors">
        ...
        {filteredIntegrations.length === 0 && (
          <div className="p-16 flex flex-col items-center text-center justify-center">
            ...
            <p className="text-[13px] font-semibold text-slate-900">No matching integrations</p>
            <p className="text-[12px] text-slate-500 mt-0.5">We couldn't find any tools matching "{searchQuery}"</p>
          </div>
        )}
      </div>
    </EcosystemWrapper>
