            ...
            <div className="p-0">
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  ...
                  addition, when using this platform's particular services, you
              ...
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  You agree to use the platform only for lawful purposes. You
                  ...
                  material that could constitute or encourage conduct that would
                  be considered a criminal offense, give rise to civil
              ...
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  You retain all rights and ownership of your content. However,
                  by uploading content to the platform, you grant us a
                  worldwide, non-exclusive, royalty-free license to use,
                  reproduce, and display the content in connection with
                  providing the service. We claim no intellectual property
                  rights over the material you provide to the service.
                </p>
              </div>
            </div>
          </div>
