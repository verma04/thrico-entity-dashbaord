            ...
            <div className="p-0">
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  ...
                  you use our services. This includes contact information such
                  as name, email address, and phone number; account credentials;
                  and payment information. We also automatically collect certain
                  technical data when you visit our platform, including IP
              ...
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  ...
                  our services. Specifically, we use it to process transactions,
                  send necessary notifications, provide customer support, and
                  detect fraud. We may also use aggregated, anonymized data for
                  analytics to understand user behavior and enhance our
              ...
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  ...
                  share information with trusted service providers who assist us
                  in operating our website, conducting our business, or serving
                  our users, so long as those parties agree to keep this
                  information confidential. Legal requirements may also compel
                  us to disclose information to authorities.
                </p>
              </div>
              ...
              <div className="p-5 border-b border-border last:border-0 hover:bg-muted/50 transition-colors">
                ...
                <p className="text-[12px] text-muted-foreground leading-relaxed max-w-3xl">
                  ...
                  data. You can manage your communication preferences and
                  opt-out of marketing communications at any time. If you wish
                  to exercise these rights, please contact our support team or
                  use the tools provided in your account settings.
                </p>
              </div>
            </div>
          </div>
