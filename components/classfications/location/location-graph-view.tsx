  ...
  return (
    <div className="absolute top-4 left-4 z-20 w-72 rounded-xl bg-white border border-slate-200 shadow-lg overflow-hidden animate-in slide-in-from-left-2 fade-in duration-200">
      ...
      <div className="px-4 py-4 space-y-4">
        <h3 className="text-sm font-semibold text-slate-900">{location.title}</h3>
  ...
  const legend = (
    <>
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="text-[10px] font-medium text-slate-500 uppercase tracking-wider">Locations</span>
      </div>
    </>
  );
