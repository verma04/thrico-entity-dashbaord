...
import { Send, ArrowRight, CheckCircle2, Clock, Eye, MousePointerClick, MoreHorizontal, Mail } from "lucide-react";
...
export function EmailRecentCampaigns({ recentEmails = [] }: EmailRecentCampaignsProps) {
