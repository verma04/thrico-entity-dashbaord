...
import { BadgesTableList } from "./badges-table-list";
...
export type BadgeStatusValue = (typeof STATUS_TABS)[number]["value"];

export const SORT_OPTIONS = [
  { value: "newest", label: "Newest First" },
  { value: "oldest", label: "Oldest First" },
  { value: "name", label: "Name A–Z" },
  { value: "points", label: "Points / Target High" },
];
          ...
          {view === "grid" ? (
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div className="h-10 border-b border-border bg-muted/30 px-5 flex items-center gap-4">
                {[40, 180, 100, 120, 140, 80, 100].map((w, i) => (
                  <Skeleton
                    key={i}
