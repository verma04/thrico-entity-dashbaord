...
export type SelectedCurrencyNode =
  | { type: "trigger" }
  | { type: "condition" }
  | { type: "action"; index: number }
  | null;

interface CurrencyNodeInspectorProps {
  selectedNode: SelectedCurrencyNode;
  onClose: () => void;
  trigger: CurrencyRuleTrigger;
  onTriggerChange: (t: CurrencyRuleTrigger) => void;
...
export const CurrencyNodeInspector: React.FC<CurrencyNodeInspectorProps> = ({
  selectedNode,
  onClose,
  trigger,
  onTriggerChange,
      ...
      {selectedNode.type === "trigger" && (
        <div className="space-y-4">
          <div className="space-y-1.5">
            ...
            <Select
              value={trigger}
              onValueChange={(val) => onTriggerChange(val as CurrencyRuleTrigger)}
            >
            ...
            <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">
              This automation will evaluate wallet transactions matching this event type.
            </p>
          </div>
        </div>
      )}
              ...
              <div className="space-y-4">
                ...
                {action.type === "AWARD_CURRENCY" && (
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1.5">
                      <PolarisLabel required>Currency Amount</PolarisLabel>
                      <PolarisInput
                        type="number"
                        value={
                          action.currency?.amount ??
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1.5">
                      ...
                      <PolarisInput
                        ...
                        placeholder="e.g. Wallet Bonus Awarded!"
                      />
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        rows={3}
                        className="w-full rounded-lg border border-border bg-card p-2 text-xs font-normal"
                      />
                    </div>
                  </div>
                )}
                ...
                {action.type === "ADD_MEMBER_TAG" && (
                  <div className="space-y-1.5">
                    <PolarisLabel required>Tags (Comma-separated)</PolarisLabel>
                    <PolarisInput
