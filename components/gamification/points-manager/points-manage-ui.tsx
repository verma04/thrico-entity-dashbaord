...
import { PointRulesGrid } from "./point-rules-grid";
import { PointRulesList } from "./point-rules-list";
...
export type PointRuleStatusValue = (typeof STATUS_TABS)[number]["value"];
  ...
  return (
    <div className="flex items-center gap-3 pb-1">
      ...
      >
        ...
        <span>{tab.label} Point Rules</span>
      </div>
          ...
          {view === "grid" ? (
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div className="h-10 border-b border-border bg-muted/30 px-5 flex items-center gap-4">
                {[40, 160, 100, 140, 80, 80, 80, 100].map((w, i) => (
                  <Skeleton
                    key={i}
