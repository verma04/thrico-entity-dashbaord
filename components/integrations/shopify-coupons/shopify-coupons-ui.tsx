...
import { ShopifyCouponGrid } from "./shopify-coupon-grid";
import { ShopifyCouponsList } from "./shopify-coupons-list";
...
export type ShopifyCouponStatusValue = (typeof STATUS_TABS)[number]["value"];
          ...
          {view === "grid" ? (
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div className="h-10 border-b border-border bg-muted/30 px-5 flex items-center gap-4">
                {[40, 160, 100, 120, 80, 80, 100].map((w, i) => (
                  <Skeleton
                    key={i}
