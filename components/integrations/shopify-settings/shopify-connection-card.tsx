...
export function ShopifyConnectionCard({
  ...
  return (
    <PolarisFormCard
      ...
      badge={isConnected ? "Active Store" : "Not Linked"}
    >
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 leading-relaxed">
                {isConnected
                  ? "Connected via Shopify OAuth with read and write permissions for orders, customers, and discounts."
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="p-3 rounded-lg border border-zinc-200/80 dark:border-zinc-800 bg-white dark:bg-zinc-800/40 space-y-1">
            ...
            <p className="text-xs font-bold text-zinc-900 dark:text-zinc-100 truncate">
              {isConnected ? "Active & Linked" : "Not Linked"}
            </p>
          </div>
