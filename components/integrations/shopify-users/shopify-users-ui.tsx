...
import { ShopifyUserGrid } from "./shopify-user-grid";
import { ShopifyUsersList } from "./shopify-users-list";
...
export type ShopifyUserStatusValue = (typeof STATUS_TABS)[number]["value"];
