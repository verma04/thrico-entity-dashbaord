...
import { Briefcase, List, Users, Network, Plus, ArrowRight } from "lucide-react";
import { DashboardSectionHeading } from "@/components/home/dashboard-section-heading";
import { cn } from "@/lib/utils";

interface JobsShortcutsProps {
  moduleName?: string;
  singularName?: string;
}

export function JobsShortcuts({
  moduleName = "Jobs",
  singularName = "Job",
}: JobsShortcutsProps) {
  const shortcuts = [
    {
      ...
      description: "Manage active openings & listings",
      href: "/jobs/all",
      icon: List,
    ...
    {
      title: "Graph View",
      description: "Talent & recruiter network matrix",
      href: "/jobs/graph",
      icon: Network,
    ...
    },
    {
      ...
      description: "Publish a new career opportunity",
      href: "/jobs/create",
      icon: Plus,
