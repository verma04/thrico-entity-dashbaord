...
interface ListingsCategoryMixChartProps {
  loading: boolean;
  data: CategoryMixItem[];
}

export function ListingsCategoryMixChart({
  loading,
  data,
}: ListingsCategoryMixChartProps) {
        ...
        <CardContent className="p-5 flex-1 flex flex-col justify-between">
          {loading ? (
            ...
            <div className="h-[260px] w-full flex flex-col items-center justify-center text-center text-muted-foreground">
              ...
              <span className="text-xs">No category mix data recorded yet</span>
            </div>
          ) : (
            <>
