...
import { Store, List, Tag, Network, Plus, ArrowRight } from "lucide-react";
import { DashboardSectionHeading } from "@/components/home/dashboard-section-heading";
import { cn } from "@/lib/utils";

interface ListingsShortcutsProps {
  moduleName?: string;
  singularName?: string;
}

export function ListingsShortcuts({
  moduleName = "Marketplace",
  singularName = "Listing",
}: ListingsShortcutsProps) {
  const shortcuts = [
    {
      title: `All ${moduleName}`,
      description: "Manage catalog products & items",
      href: "/listing/all",
      icon: List,
    ...
    },
    {
      ...
      description: "Seller rules and guidelines",
      href: "/listing/terms",
      icon: Tag,
    ...
    {
      title: "Graph View",
      description: "Product categories & vendor network",
      href: "/listing/graph",
      icon: Network,
    ...
    },
    {
      ...
      description: "Publish a new catalog item",
      href: "/listing/create",
      icon: Plus,
