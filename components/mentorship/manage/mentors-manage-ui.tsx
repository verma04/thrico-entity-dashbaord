...
import { Mentor } from "@/graphql/mentorship/mentorship-quiries";
...
export type MentorStatusValue = (typeof STATUS_TABS)[number]["value"];
  ...
  return (
    <AnimatePresence mode="wait">
      {loading ? (
        ...
        >
          {view === "grid" ? (
            <MentorGrid mentors={mentors} onEdit={onEdit} refetch={refetch} />
          ) : (
            <MentorsList
              mentors={mentors}
              onEdit={onEdit}
