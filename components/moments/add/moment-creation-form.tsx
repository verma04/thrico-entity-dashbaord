        ...
        sidebar={
          <div className="space-y-4">
            ...
            <PolarisSidebarCard
              ...
              icon={Sparkles}
            >
              <div className="aspect-[9/16] relative bg-zinc-950 rounded-[8px] border border-[#d2d5d9] dark:border-zinc-800 overflow-hidden group shadow-2xs flex flex-col justify-between">
                {videoPreviewUrl ? (
                  <video
                    src={videoPreviewUrl}
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 text-zinc-500">
                    ...
                    <span className="text-[9.5px] font-bold uppercase tracking-widest text-zinc-400">
                      Story Player
                    </span>
                  </div>
                )}
                ...
                {/* Top Status Bar */}
                <div className="relative z-10 p-3 flex items-center justify-between bg-gradient-to-b from-black/60 to-transparent">
                  <div className="flex items-center gap-1.5">
                    <div className="h-6 w-6 rounded-full bg-zinc-800 border border-white/20 flex items-center justify-center text-white text-[9.5px] font-bold">
                      {singularName.charAt(0)}
                    </div>
                    <span className="text-[11.5px] font-semibold text-white truncate max-w-[120px]">
                      {singularName}
                    </span>
                  </div>
                  {formik.values.isAiContent && (
                    <span className="px-1.5 py-0.5 rounded-[3px] bg-black/60 backdrop-blur-xs text-white text-[8.5px] font-bold flex items-center gap-1 border border-white/10">
                ...
                <div className="relative z-10 p-3 bg-gradient-to-t from-black/80 via-black/40 to-transparent space-y-1.5">
                  <p className="text-[11.5px] font-medium text-white/95 line-clamp-3 leading-[15px]">
          ...
          {step === 1 ? (
            ...
            >
              ...
              <div className="space-y-1.5">
                <PolarisLabel required>Video File (9:16 Vertical)</PolarisLabel>
                {!videoFile ? (
                  <div className="relative group">
                    ...
                    />
                    <div className="border-2 border-dashed border-[#d2d5d9] dark:border-zinc-800 rounded-[6px] py-8 flex flex-col items-center justify-center gap-1.5 bg-[#f6f6f7]/60 dark:bg-zinc-900/50 group-hover:bg-[#f6f6f7] dark:group-hover:bg-zinc-800/50 transition-all cursor-pointer">
                      <div className="h-9 w-9 rounded-[6px] bg-white dark:bg-zinc-800 border border-[#d2d5d9] flex items-center justify-center text-[#616161] dark:text-zinc-400">
                        <CloudUpload className="h-4 w-4" />
                      </div>
                      <div className="text-center">
                        <p className="text-[12.5px] font-semibold text-[#303030] dark:text-zinc-200">
                  ...
                  <div className="flex items-center justify-between p-3 rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-[#f6f6f7]/50 dark:bg-zinc-900/50">
                    <div className="flex items-center gap-2.5">
                      <div className="h-8 w-8 rounded-[4px] bg-[#303030] text-white dark:bg-zinc-100 dark:text-zinc-900 flex items-center justify-center shrink-0">
                        <FileVideo className="h-3.5 w-3.5" />
                      </div>
                      <div className="min-w-0">
                        <p className="text-[12.5px] font-semibold text-[#303030] dark:text-zinc-100 truncate max-w-[280px]">
                          {videoFile.name}
                        </p>
                    ...
                    <Button
                      ...
                      variant="ghost"
                      size="icon"
                      className="h-7 w-7 text-[#616161] hover:text-[#d72c0d] hover:bg-rose-50 dark:hover:bg-rose-950/20 cursor-pointer rounded-[4px]"
                      onClick={() => {
                        setVideoFile(null);
              ...
              <div className="space-y-1.5 pt-2 border-t border-[#e1e3e5] dark:border-zinc-800">
                <PolarisLabel>Custom Static Cover Frame (Optional)</PolarisLabel>
                <div className="flex items-start gap-3 p-3 rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-[#f6f6f7]/40 dark:bg-zinc-900/30">
                  <div className="w-16 aspect-[9/16] rounded-[4px] bg-[#e1e3e5] dark:bg-zinc-800 border border-[#d2d5d9] dark:border-zinc-700 flex items-center justify-center overflow-hidden relative group shrink-0">
                    {thumbnailUrl ? (
                      <Image
                        src={thumbnailUrl}
                        alt="Thumbnail"
                      ...
                      <ImageIcon className="h-4 w-4 text-[#8c9196]" />
                    )}
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <ImageUploadWithCrop
                        ...
                        aspectRatio={9 / 16}
                        className="p-0"
                        dropzoneClassName="h-6 w-6 rounded-full bg-white text-zinc-900 flex items-center justify-center p-0 cursor-pointer shadow-md"
            ...
            >
              ...
              <PolarisTextarea
                ...
                helperText={`${formik.values.caption.length} / 500 characters`}
                error={formik.touched.caption && formik.errors.caption ? String(formik.errors.caption) : undefined}
              />

              {/* Toggles */}
              <div className="space-y-2.5 pt-2 border-t border-[#e1e3e5] dark:border-zinc-800">
                <PolarisLabel>Distribution Settings</PolarisLabel>
                ...
                <div className="flex items-center justify-between p-3 rounded-[6px] border border-[#d2d5d9] dark:border-zinc-800 bg-[#f6f6f7]/50 dark:bg-zinc-900/50">
                  <div className="space-y-0.5">
                    <span className="text-[12.5px] font-semibold text-[#303030] dark:text-zinc-100 flex items-center gap-1.5">
                      <Sparkles className="h-3 w-3 text-[#616161]" />
