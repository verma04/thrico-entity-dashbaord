      ...
      if (offer) {
        ...
        toast({
          ...
          description: `"${values.title}" has been ${
            source === "admin" ? "created" : "submitted for approval"
          }.`,
        });
      }
            ...
            <div className="max-w-7xl mx-auto w-full flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                ...
                <div className="flex items-center gap-2 text-xs text-muted-foreground ml-1">
                  ...
                  <span>{offer ? "Edit" : "Create New"}</span>
                </div>
              </div>
                  ...
                  <div className="sticky top-6 space-y-6">
                      ...
                      <CardContent className="pt-6 space-y-6">
                        ...
                        <div className="flex flex-wrap gap-2">
                          ...
                          {formik.values.isFeatured && (
                            <Badge
                              variant="secondary"
                              className="bg-yellow-500/5 text-yellow-600 border-yellow-500/10"
                            >
                    ...
                    <div className="p-4 rounded-xl bg-muted/30 border border-dashed border-border flex items-start gap-4">
                      ...
                      <p className="text-xs text-muted-foreground leading-relaxed">
                        Make sure your offer image is clear and your description
                        highlights the key benefits to attract more users.
                      </p>
                    </div>
                  </div>
                </div>
