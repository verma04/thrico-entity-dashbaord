...
import { Vote, List, CheckSquare, Plus, ArrowRight } from "lucide-react";
import { DashboardSectionHeading } from "@/components/home/dashboard-section-heading";
import { cn } from "@/lib/utils";

interface PollsShortcutsProps {
  moduleName?: string;
  singularName?: string;
}

export function PollsShortcuts({
  moduleName = "Polls",
  singularName = "Poll",
}: PollsShortcutsProps) {
  const shortcuts = [
    {
      ...
      description: "Manage published & scheduled polls",
      href: "/polls/all",
      icon: List,
    ...
    {
      title: "Active Voting Hub",
      description: "Live real-time community ballots",
      href: "/polls/all",
      icon: Vote,
    ...
    },
    {
      ...
      description: "Sentiment analysis & tally reports",
      href: "/polls/all",
      icon: CheckSquare,
    ...
    },
    {
      ...
      description: "Launch a new community poll",
      href: "/polls/create",
      icon: Plus,
  ...
  return (
    <section className="space-y-3 flex flex-col h-full">
      <DashboardSectionHeading
        ...
        icon={<Vote className="h-3.5 w-3.5 text-muted-foreground" />}
      />
