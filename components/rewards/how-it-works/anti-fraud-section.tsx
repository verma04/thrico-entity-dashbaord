      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          ...
          <h2 className="text-lg font-bold text-foreground">
            Dynamic Audience Targeting & Anti-Fraud Engine
          </h2>
          <p className="text-xs text-muted-foreground">
            Protect your budget and ensure rewards reach genuine, high-value
            community members with multi-layered verification rules.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {FRAUD_GUARDS.map((guard, idx) => {
          ...
          return (
            <Card
              key={idx}
              className="rounded-xl border-border/60 bg-card/60 backdrop-blur-xs p-4 space-y-3 hover:border-primary/40 hover:shadow-xs transition-all"
            >
