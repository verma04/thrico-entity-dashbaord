...
import { SpinWheelGrid } from "./spin-wheel-grid";
import { SpinWheelList } from "./spin-wheel-list";
...
export type SpinStatusValue = (typeof STATUS_TABS)[number]["value"];

export const getRewardTypeFilterOptions = (currencyName: string = "Points") => [
  { value: "ALL", label: "All Reward Types", icon: Dices },
          ...
          {view === "grid" ? (
            ...
            <div className="overflow-hidden rounded-xl border border-border bg-card">
              <div className="h-10 border-b border-border bg-muted/30 px-5 flex items-center gap-4">
                {[40, 180, 100, 100, 100, 80, 80, 40].map((w, i) => (
                  <Skeleton
                    key={i}
