...
export interface SpecialSponsorshipTier {
  id: string;
  sponsorType: string;
  sponsors: SpecialSponsor[];
}

interface SpecialSponsorsDisplayGridProps {
  sponsorships: SpecialSponsorshipTier[];
  title?: string;
  className?: string;
}

export function SpecialSponsorsDisplayGrid({
  sponsorships,
  title = "Ecosystem Partners",
  className = "",
}: SpecialSponsorsDisplayGridProps) {
