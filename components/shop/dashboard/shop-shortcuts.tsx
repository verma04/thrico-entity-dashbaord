...
import { ShoppingBag, List, ImageIcon, Plus, ArrowRight } from "lucide-react";
  ...
  const shortcuts = [
    {
      ...
      description: "Manage shop inventory & catalog items",
      href: "/shop/all",
      icon: List,
    ...
    {
      title: "Hero Banners",
      description: "Configure promotional storefront banners",
      href: "/shop/banners",
      icon: ImageIcon,
    ...
    },
    {
      ...
      description: "Currency, shipping & payment policies",
      href: "/shop/settings",
      icon: ShoppingBag,
    ...
    },
    {
      ...
      description: "Publish a new merchandise product",
      href: "/shop/create",
      icon: Plus,
        ...
        {shortcuts.map((shortcut) => {
          ...
          return (
            <Link
              ...
              href={shortcut.href}
              className="flex items-center justify-between p-3.5 rounded-xl border border-border/60 bg-card hover:border-primary/40 hover:shadow-xs transition-all group"
            >
              <div className="flex items-center gap-3 min-w-0">
                <div
                  className={cn(
                    "h-9 w-9 rounded-lg flex items-center justify-center shrink-0 border transition-transform group-hover:scale-105",
                    shortcut.bg
                  )}
                >
