    ...
    <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-border flex items-center justify-between gap-4">
        <div>
          ...
          <h2 className="text-[14px] font-semibold text-foreground leading-none tracking-tight mt-1">
            Enhance your plan
          </h2>
        </div>
        <div className="flex items-center gap-1.5 text-[11px] text-muted-foreground bg-muted/50 border border-border px-3 py-1.5 rounded-lg">
          <Info className="h-3 w-3" />
          Adapts to your <strong className="text-muted-foreground font-semibold">{billingCycle}</strong> cycle
        </div>
      </div>
      ...
      <div className="p-5">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {addons.map((addon, index) => (
            <div
              ...
              className={cn(
                "relative flex flex-col rounded-xl border bg-card cursor-pointer transition-all duration-150 hover:shadow-md overflow-hidden",
                index === 1
            ...
            >
              ...
              <div className="px-4 pt-4 pb-3 border-b border-border">
                ...
                <h3 className="text-[14px] font-semibold text-foreground leading-none tracking-tight">
                  {addon.name}
                </h3>
                <p className="text-[12px] text-muted-foreground mt-1.5 line-clamp-2 leading-snug">
                  {addon.description}
                </p>
              </div>
              ...
              <div className="px-4 pb-4 pt-2">
                ...
                <p className="text-[10px] text-center text-muted-foreground uppercase font-semibold tracking-widest mt-2">
                  Billed {billingCycle}
                </p>
              </div>
            </div>
        ...
        {/* Fine print */}
        <div className="mt-4 px-4 py-3 bg-muted/50 border border-border rounded-lg flex items-start justify-between gap-4">
          <div className="flex items-start gap-2.5">
            <Info className="h-3.5 w-3.5 text-muted-foreground mt-0.5 shrink-0" />
            <div>
              <p className="text-[12px] font-semibold text-foreground">Billed separately</p>
              <p className="text-[11px] text-muted-foreground mt-0.5">
                Add-ons are not included in your main subscription. Manage them in billing settings.
              </p>
            </div>
          </div>
          <Button variant="link" className="text-[12px] font-semibold text-muted-foreground hover:text-foreground gap-1 shrink-0 h-auto px-0 py-0">
            Contact Support
