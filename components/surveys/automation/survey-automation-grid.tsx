...
interface SurveyAutomationGridProps {
...
export const SurveyAutomationGrid: React.FC<SurveyAutomationGridProps> = ({
  rules,
  onEdit,
  onToggle,
  onDelete,
  ...
  const getTriggerMeta = (trigger: SurveyRuleTrigger) => {
    switch (trigger) {
      case "SURVEY_SUBMITTED":
        return {
          ...
          bannerClass: "from-cyan-500/10 via-cyan-500/5 to-transparent",
        };
      ...
      case "SURVEY_CREATED":
        return {
          ...
          bannerClass: "from-indigo-500/10 via-indigo-500/5 to-transparent",
        };
      default:
        return {
          label: trigger,
            ...
            <div className="p-4 space-y-3.5 flex-1">
              ...
              >
                <div className="flex items-center gap-1.5 text-[10px] text-muted-foreground font-semibold">
                  ...
                  <span className="truncate max-w-[200px]">
                    {rule.surveyName ? rule.surveyName : "Global (All Surveys)"}
                  </span>
                </div>
                ...
                <p className="text-[11px] text-zinc-500 dark:text-zinc-400 line-clamp-2 leading-relaxed">
                  {rule.description || "Survey automated response rule."}
                </p>
              </div>
              ...
              <div className="space-y-1.5 pt-2 border-t border-zinc-100 dark:border-zinc-800/80">
                <div className="text-[10px] font-semibold text-zinc-400 uppercase tracking-wider">
                  Target Criteria ({rule.conditions?.length || 0})
                </div>
                    ...
                    rule.conditions.map((c, i) => (
                      ...
                      >
                        <span className="font-bold">
                          {c.field.replace("context.", "").replace("response.", "")}:
                        </span>
              ...
              <div className="space-y-1.5 pt-2 border-t border-zinc-100 dark:border-zinc-800/80">
                ...
                <div className="flex flex-wrap gap-1.5">
                  {rule.actions.map((act, i) => {
                    switch (act.type as SurveyRuleActionType) {
