...
import { ClipboardList, List, FileText, Plus, ArrowRight } from "lucide-react";
import { DashboardSectionHeading } from "@/components/home/dashboard-section-heading";
import { cn } from "@/lib/utils";

interface SurveysShortcutsProps {
  moduleName?: string;
  singularName?: string;
}

export function SurveysShortcuts({
  moduleName = "Surveys",
  singularName = "Survey",
}: SurveysShortcutsProps) {
  const shortcuts = [
    {
      title: `All ${moduleName}`,
      description: "Manage live & archived questionnaires",
      href: "/surveys/all",
      icon: List,
    ...
    },
    {
      ...
      description: "Pre-built form presets & blueprints",
    ...
    {
      title: "Responses & Reports",
      description: "Aggregated respondent metrics",
      href: "/surveys/reports",
      icon: ClipboardList,
    ...
    },
    {
      ...
      description: "Publish a new survey questionnaire",
      href: "/surveys/create",
      icon: Plus,
