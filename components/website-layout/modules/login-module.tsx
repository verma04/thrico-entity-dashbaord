...
export function LoginModule({ module, previewDevice }: LoginModuleProps) {
  return (
    <div className="w-full min-h-[520px] flex flex-col items-center justify-center p-6 md:p-12 bg-muted/20">
