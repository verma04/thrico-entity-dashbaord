              ...
              {honorees[1] && (
                <div className="flex-1 text-center">
                  <div className="bg-gradient-to-br from-gray-300 to-gray-400 rounded-t-2xl p-8 pt-12">
                    ...
                    <p className="text-sm text-white/80">{honorees[1].achievement}</p>
                  </div>
                  <div className="bg-gray-400 text-white font-bold py-3 text-2xl">2</div>
                </div>
              )}
              ...
              {honorees[0] && (
                <div className="flex-1 text-center">
                  <div className="bg-gradient-to-br from-yellow-400 to-amber-500 rounded-t-2xl p-8 pt-16 relative">
                    ...
                    <p className="text-sm text-white/90">{honorees[0].achievement}</p>
                  </div>
                  <div className="bg-amber-500 text-white font-bold py-4 text-3xl">1</div>
                </div>
              )}
              ...
              {honorees[2] && (
                <div className="flex-1 text-center">
                  <div className="bg-gradient-to-br from-orange-300 to-orange-400 rounded-t-2xl p-8 pt-10">
                    ...
                    <p className="text-xs text-white/80">{honorees[2].achievement}</p>
                  </div>
                  <div className="bg-orange-400 text-white font-bold py-2 text-xl">3</div>
                </div>
              )}
            </div>
                ...
                <div className="bg-gradient-to-r from-amber-400 to-orange-500 p-6 text-white relative">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      {honoree.year && (
                        <p className="text-sm opacity-90">Class of {honoree.year}</p>
                      )}
                    </div>
                  </div>
                </div>
